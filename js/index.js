...
const gundurraga = [
  ...
  },
  {
    ...
    UserID: "gundurraga",
    Artist: "Gregorio Undurraga",
    ArtworkTitle: "Meringue and Lemon",
    ArtworkYear: 2024,
    ArtworkLocation: "Santiago, Chile",
    Location: "santiago",
    ArtworkMedia: "Oil on canvas",
    ...
    CountryId: "cl",
    Country: "Chile",
    DimensionCm: "65 x 65 cm",
    ImageSize: "Assumed Size in MB",
    ImageDimension: "Assumed Pixel Dimension",
    onSale: true,
  },
  {
    ID: "the-onions-smile-2024",
    UserID: "gundurraga",
    Artist: "Gregorio Undurraga",
    ArtworkTitle: "The Onions Smile",
    ArtworkYear: 2024,
    ArtworkLocation: "Santiago, Chile",
    Location: "santiago",
    ArtworkMedia: "Oil on canvas",
  ...
  {
    ID: "the-natural-order-of-things-2024",
    UserID: "gundurraga",
    Artist: "Gregorio Undurraga",
    ArtworkTitle: "The Natural Order of Things",
    ArtworkYear: 2024,
    ArtworkLocation: "Santiago, Chile",
    Location: "santiago",
    ArtworkMedia: "Diptych, oil on canvas",
    ArtworkMediaID: "diptych_oilcanvas",
    BirthYear: 1993,
    CountryId: "cl",
    Country: "Chile",
    DimensionCm: "106 x 132 cm",
    ImageSize: "Assumed Size in MB",
    ImageDimension: "Assumed Pixel Dimension",
    onSale: false,
  },
  {
    ...
    UserID: "gundurraga",
    Artist: "Gregorio Undurraga",
    ArtworkTitle: "Blue Night (Hopper)",
    ArtworkYear: 2024,
    ArtworkLocation: "Santiago, Chile",
    Location: "santiago",
    ArtworkMedia: "Oil on canvas",
  ...
  },
  {
    ...
    UserID: "gundurraga",
    Artist: "Gregorio Undurraga",
    ArtworkTitle: "The Winged Victory of Samothrace",
    ArtworkYear: 2024,
    ArtworkLocation: "Santiago, Chile",
    Location: "santiago",
    ArtworkMedia: "Oil on canvas",
  ...
  },
  {
    ...
    UserID: "gundurraga",
    Artist: "Gregorio Undurraga",
    ArtworkTitle: "The Cardsharps (Caravaggio)",
    ArtworkYear: 2024,
    ArtworkLocation: "Santiago, Chile",
    Location: "santiago",
    ArtworkMedia: "Oil on canvas",
  ...
  },
  {
    ...
    UserID: "gundurraga",
    Artist: "Gregorio Undurraga",
    ArtworkTitle: "The Straw Manikin (Goya)",
    ArtworkYear: 2024,
    ArtworkLocation: "Santiago, Chile",
    Location: "santiago",
    ArtworkMedia: "Oil on canvas",
...
<a class="header-logo" href="https://gregorioundurraga.com">
  <div class="logo">
    <div class="inside-logo noisy"></div>
  </div>
