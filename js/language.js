...
let ja = {
  ...
  oilpaper: "紙に油彩",
  mixed: "ミクストメディア",
  diptych_oilcanvas: "二連作、カンヴァスに油彩",

  // アートワーク
  green_washing: "グリーンウォッシング",
  nothing_new: "新しいものは何もない",
  in_search_of_the_perfect_quesadilla: "完璧なケサディーヤを求めて",
  meringue_and_lemon: "メレンゲとレモン",
  the_onions_smile: "玉ねぎの微笑み",
  the_natural_order_of_things: "物事の自然な秩序",
  blue_night_hopper: "ブルーナイト（ホッパー）",
  the_winged_victory_of_samothrace: "サモトラケのニケ",
  air: "空気",
  venus_de_milo: "ミロのヴィーナス",
  the_cardsharps_caravaggio: "いかさま師（カラヴァッジョ）",
  the_straw_manikin_goya: "藁人形（ゴヤ）",
  wapping_on_thames_whistler: "テムズ川のワッピング（ホイッスラー）",
  ...
  the_flamingos: "フラミンゴ",
  luma_park: "ルマ・パーク",
  underwater_museum_of_conceptual_art: "コンセプチュアルアートの水中美術館",
  the_fruitful_life_of_dogs: "犬の実り多き生活",
  sunflower_bull: "ひまわりの雄牛",
  electric_dreams: "エレクトリック・ドリーム",
  formal_and_polite: "端正で礼儀正しく",
  family_holidays_in_the_caribbean: "カリブ海の家族旅行",
  the_peace_of_wild_things: "野生のものの安らぎ",
  bears_like_contemporary_art_too: "クマも現代アートが好き",
  ...
  public_works: "公共事業",
  the_sleeping_backhoe: "眠るバックホー",
  composition_i: "コンポジション I",
  the_train_station: "駅",
  wind_cows: "風の牛",
  airplane: "飛行機",
  yellow_submarine: "イエロー・サブマリン",
  pythagoras: "ピタゴラス",
  good_morning_madame_giraffe: "おはよう、キリン夫人",
  swirl: "渦",
  creme_brulee: "クレームブリュレ",
  spheres: "球体",
  window: "窓",
  wrath_of_the_gods: "神々の怒り",
  studio_escalier_ii: "スタジオ・エスカリエ II",
  studio_escalier_i: "スタジオ・エスカリエ I",
  space_xploration: "宇宙探検",
  modern_curves: "モダンな曲線",
  the_city: "都市",
  fosforos_copihue: "フォスフォロス・コピウエ",
  chocolate_on_chocolate: "チョコレートの上のチョコレート",
  mona_lisa: "モナ・リザ",
  cat: "猫",
  mosaic_escher: "エッシャーのモザイク",
  earth: "地球",
  margherita: "マルゲリータ",
  ...
  pura_vida_road: "プラ・ビダ通り",
  scarlet_macaws: "ベニコンゴウインコ",
  three_motorcycles: "三台のオートバイ",
  aloe_vera: "アロエベラ",
  the_race: "レース",
  untitled_i: "無題 I",
};
